...
struct ObsPoint
{
	...
	string radar_image_filename, radar_fits_filename,
		   ...
		   mag_filename, flux_filename, storage_name;
};
...
public:
    ...
    vector<ObsPoint> deserialize_storage(string filepath);
    vector<ObsPoint> deserialize_damit_lc(string filepath, Entity&, Entity&);
